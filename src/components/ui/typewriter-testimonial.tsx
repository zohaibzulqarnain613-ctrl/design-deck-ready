...
export const Component: React.FC<ComponentProps> = ({ testimonials }) => {
  ...
  const handleMouseEnter = useCallback((index: number) => {
    ...
    // Skip audio playback since we don't have audio files
          ...
          <AnimatePresence>
            {hoveredIndex === index && (
              <motion.div
                ...
                className="absolute bottom-20 bg-white text-black text-sm px-4 py-3 rounded-lg shadow-2xl max-w-xs w-56 z-10"
              >
