...
export function SterlingGateKineticNavigation() {
  ...
  return (
    <div ref={containerRef} className="relative z-50">
      ...
      <button 
        onClick={toggleMenu}
        className="group relative flex items-center gap-3 px-6 py-2.5 rounded-full bg-blue-600 border border-blue-400 text-white hover:bg-blue-500 transition-all duration-300 shadow-[0_0_20px_rgba(59,130,246,0.5)] cursor-pointer"
      >
